  ...
  return (
    <nav className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4">
        ...
        {/* Desktop Navigation */}
        <div className="hidden lg:flex items-center justify-between space-x-2  pb-2">
          <Link
            to="/shop"
            className={`text-gray-700 hover:text-blue-600 transition-colors ${
              location.pathname === '/shop' ? 'text-blue-600 font-medium' : ''
            }`}
          >
            Shop
          </Link>
          <Link
            to="/power-solutions"
            className={`text-gray-700 hover:text-blue-600 transition-colors ${
              location.pathname === '/power-solutions' ? 'text-blue-600 font-medium' : ''
            }`}
          >
            Power Solutions
          </Link>
          ...
          <Link
            to="/rental"
            className={`text-gray-700 hover:text-blue-600 transition-colors ${
              location.pathname === '/rental' ? 'text-blue-600 font-medium' : ''
            }`}
          >
            Rental
          </Link>
          <Link
            to="/blog"
            className={`text-gray-700 hover:text-blue-600 transition-colors ${
              location.pathname === '/blog' ? 'text-blue-600 font-medium' : ''
            }`}
          >
            Blog
          </Link>
          ...
          <Link
            to="/customers"
            className={`text-gray-700 hover:text-blue-600 transition-colors ${
              location.pathname === '/customers' ? 'text-blue-600 font-medium' : ''
            }`}
          >
            Our Customers
          </Link>
        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 border-t border-gray-200">
            <div className="space-y-4">
              ...
              <Link to="/power-solutions" onClick={handleMobileLinkClick} className="block text-gray-700 hover:text-blue-600 transition-colors">Power Solutions</Link>

              {/* IT Products Mobile Dropdown */}
              <div>
                <button
              ...
              {/* Security Solutions Mobile Dropdown */}
              <div>
                <button
